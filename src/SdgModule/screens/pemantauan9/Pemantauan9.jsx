...
<img src={Vector2  } alt=''/>
                ...
                <div className='display-p8'>
                <div className='p4inner-input8'>
                  ...
                  <button style={{ border: "none", color: "#FF4B55", background: "pink", width: "100px", height: "35px", margin: " 20px 10px 0 10px" }}>
                                        Reset
                                    </button>
                                    <button style={{ border: "none", color: "white", background: "#63B2FC", width: "100px", height: "35px" ,margin: " 20px 10px 0 10px" }}>
                                        cari
                                    </button>
                                    </div>
                </div>
      ...
      <tbody style={{fontSize:"15px"}}>
        ...
        <tr style={{textAlign:"center"}}>
          ...
          <td>Pelanggan internet/10000 <br/> pendukuk</td>
          <td><button style={{marginLeft:'10px',width:"90px",height:"25px",color:"white" ,background:"#FD397A", border:"none", borderRadius:"10px"}}>Rejected</button></td>
        ...
        <tr style={{textAlign:"center"}}>
          ...
          <td>Pelanggan internet/10000 <br/> pendukuk</td>
          <td>Pelanggan internet/10000 <br/> pendukuk</td>
          <td><button style={{marginLeft:'10px',width:"90px",height:"25px",color:"white", background:"#47C4AB", border:"none", borderRadius:"10px"}}>Verified </button></td>
          <td><button style={{width:"90px", height:"20px",paddingLeft:"30px", borderRadius:"10px", border:"none",background:"white"
          }}><FiEdit style={{width:"20px",height:"20px"}}/></button></td>
        </tr>
         {/* Row 2 */}
