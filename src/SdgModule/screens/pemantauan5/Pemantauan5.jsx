...
import Vercto from './assets/Vector.svg'
import { RxCross2 } from 'react-icons/rx'
import { IoMdArrowDropup } from 'react-icons/io'
import { Pagination } from 'antd';
import { Button, Modal } from 'antd';
import ModalBig from '../pemantauan4/ModalBig'
     ...
     Cari
      ...
      <tbody style={{fontSize:"15px"}}>
        ...
        <tr style={{textAlign:"center"}}>
          ...
          <td>Pelanggan internet/10000 <br/> pendukuk</td>
          <td >
          <button style={{width:"90px", height:"20px", borderRadius:"10px", border:"none",background:"#FFE600",
          marginLeft:"20px"}} >
          Dalam Proses
          </button>
           </td>
