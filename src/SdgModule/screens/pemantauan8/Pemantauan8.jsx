...
<img src={Vector2  } alt=''/>
      ...
      <tbody style={{fontSize:"15px"}}>
        ...
        <tr style={{textAlign:"center"}}>
          ...
          <td>Pelanggan internet/10000 <br/> pendukuk</td>
          <td><button style={{marginLeft:'10px',width:"90px",height:"20px", background:"#FFE600", border:"none", borderRadius:"10px"}}>Dalam Proses</button></td>
