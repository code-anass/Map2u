...
let kategory = [
  "Sila Pilih",
  "Mempunyai lampu isyarat pintar",
  "Melaksanakan projek perintis bagi lampu isyarat pintar",
  "Tidak mempunyai lampu isyarat pintar",
];

const { Option } = Select;

function Step10({ current, setCurrent }) {
  ...
  return (
    <div className="step10-form">
      ...
      <h3>Q9 : TRAFFIC LIGHTS THAT ARE INTELLIGENT /SMART</h3>
      <Form form={form} className="" onFinish={alert} style={{ zIndex: 0 }}>
        <div className="form-inputs">
          ...
          <span className="span-x">
            Lampu isyarat pintar dapat membantu mengurangkan kesesakan
            lalulintas dan meningkatkan keselamatan jalan raya.
          </span>
        </div>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah semua lampu isyarat di kawasan PBT
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah lampu isyarat yang telah dinaiktaraf kepada lampu isyarat
              pintar di kawasan PBT
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
