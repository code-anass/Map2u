...
let kategory = [
  "Sila Pilih",
  "Menggunakan CCTV sebagai teknologi dalam pemantauan bandar selamat",
  "Tidak menggunakan CCTV sebagai teknologi dalam pemantauan bandar selamat",
];

const { Option } = Select;

function Step6({ current, setCurrent }) {
  ...
  return (
    <div className="step6-form">
      ...
      <h3>Q5 : CITY AREA COVERED BY DIGITAL SURVEILLANCE CAMERAS</h3>
      <Form form={form} className="" onFinish={alert} style={{ zIndex: 0 }}>
        <div className="form-inputs">
          ...
          <span className="span-x">
            Kamera pengawasan CCTV dapat membantu meningkatkan tahap keselamatan
            penduduk dan mengurangkan kadar jenayah di kawasan PBT. Pengawasan
            video dapat menjadi bukti bagi sesuatu insiden yang berlaku
          </span>
        </div>
        ...
        <Row>
          <Col span={16}>
            <p>
              Keluasan kawasan PBT yang diliputi oleh CCTV dalam kilometer
              persegi
              <span>*</span>
            </p>
          </Col>
