...
let kategory = [
  "Sila Pilih",
  "Melaksanakan OSC 3 0 Plus atau ‘electronic submission system’ yang setara",
  "Tidak melaksanakan OSC 3 0 Plus atau ‘electronic submission system’ yang setara",
];
...
function Step3({ current, setCurrent }) {
  ...
  return (
    <div className="step3-form">
      ...
      <h3>
        Q2 : CONSTRUCTION PERMITS SUBMITTED THROUGH AN ELECTRONIC SUBMISSION
        SYSTEM
      </h3>
      <Form form={form} className="" onFinish={alert} style={{ zIndex: 0 }}>
        <div className="form-inputs">
          ...
          <span className="span-x">
            Permohonan permit bangunan dan proses kelulusan secara dalam talian
            dapat membantu mempercepatkan proses kelulusan.
          </span>
        </div>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah Permohonan Permit /Pelan Pemajuan yang dikemukakan ke PBT
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
        ...
        <Row>
          <Col span={16}>
            <p>
              Permohonan Pelan / Permit Pemajuan yang dikemukakan ke PBT secara
              dalam talian
              <span>*</span>
            </p>
          </Col>
        ...
        <div className="table-data">
          <div className="table-content">
            ...
            <p className="ext-note">
              Lampirkan rumusan OSC 3.0 plus atau aplikasi setara (size fail
              maksima 2mb) File's Format : .pdf, .doc, .docx, .jpg, .png
            </p>
