...
let kategory = [
  "Sila Pilih",
  "Mempunyai lampu jalan pintar",
  "Melaksanakan projek perintis lampu jalan pintar",
  "Tiada mempunyai lampu jalan pintar",
];

const { Option } = Select;

function Step7({ current, setCurrent }) {
  ...
  return (
    <div className="step7-form">
      ...
      <h3>
        Q6 : SMART STREET LIGHTING MANAGED BY STREET LIGHT PERFORMANCE
        MANAGEMENT SYSTEM
      </h3>
      <Form form={form} className="" onFinish={alert} style={{ zIndex: 0 }}>
        <div className="form-inputs">
          ...
          <span className="span-x">
            Penggunaan lampu jalan pintar mengoptimumkan penggunaan tenaga dan
            meningkatkan keselamatan bandar.
          </span>
        </div>
