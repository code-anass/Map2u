...
function Step11({ current, setCurrent }) {
  ...
  return (
    <div className="step11-form">
      ...
      <h3>Q10 : CITY POPULATION WITH ACCESS TO SUFFICIENTLY FAST BROADBAND</h3>
      <Form form={form} className="" onFinish={alert} style={{ zIndex: 0 }}>
        <div className="form-inputs">
          ...
          <span className="span-x">
            Penduduk yang mempunyai akses kepada jalur lebar yang cukup pantas
            membantu masyarakat untuk mengakses kepada sumber maklumat dengan
            lebih cepat dan meluas serta meningkatkan produktiviti.
          </span>
        </div>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah penduduk di kawasan PBT
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah kawasan yang diliputi kemudahan jalurlebar berkelajuan
              tinggi (minima 256kbit/s)
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
        ...
        <div className="table-data">
          <div className="table-content">
            <h2>PEMETAAN KAWASAN LIPUTAN JALUR LEBAR OLEH SKMM NEGERI</h2>
            <hr />
            <div className="notice">
