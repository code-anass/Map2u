...
let kategory = [
  "Sila Pilih",
  "Mempunyai tempat letak kereta yang dilengkapi dengan sistem pembayaran elektronik e payment)",
  "Melaksanakan projek perintis bagi tempat letak kereta yang dilengkapi dengan sistem pembayaran elektronik e payment)",
  "Tidak mempunyai tempat letak kereta yang dilengkapi dengan sistem pembayaran elektronik e payment)",
];

const { Option } = Select;

function Step9({ current, setCurrent }) {
  ...
  return (
    <div className="step9-form">
      ...
      <h3>Q8 : PUBLIC PARKING SPACES EQUIPPED WITH E PAYMENT SYSTEMS</h3>
      <Form form={form} className="" onFinish={alert} style={{ zIndex: 0 }}>
        <div className="form-inputs">
          ...
          <span className="span-x">
            Pembayaran parking secara elektronik dapat memudahkan pengguna dan
            menjimatkan masa dimana mereka tidak perlu berbaris panjang untuk
            membuat pembayaran.
          </span>
        </div>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah semua Tempat Letak Kereta di kawasan PBT
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
        ...
        <Row>
          <Col span={16}>
            <p>
              Jumlah Tempat Letak Kereta yang dilengkapi dengan e payment
              <span>*</span>
            </p>
          </Col>
          <Col span={3}>
