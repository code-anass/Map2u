...
const tetapanInsight = () => {
    ...
    return (
        <>
          <HeaderContent title="SENARAI DASHBOARD INSIGHTS" titleBreadcrumb="Senarai Dashboard Insights"/>
          <div
            ...
            <div className="card p-3" style={{ width: "98%", backgroundImage: `url(${AngleSvg})`, backgroundSize: "100% auto", backgroundRepeat: "no-repeat", backgroundPosition: "center bottom" }}>
                    ...
                    <DataTable
                        columns={[
                            ...
                            {
                                name: "Level Dashboard",
                                selector: "levelDashboard",
                                sortable: true,
                                width: "25%",
                            },
                            {
